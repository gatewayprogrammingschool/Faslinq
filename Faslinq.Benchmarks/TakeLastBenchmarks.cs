...
public class TakeLastBenchmarks : BenchmarkBase
{
    ...
    public List<object> TakeLast_10_Faslinq(object item) => TakeLast_Faslinq(item, LastGenerateRecords1);

    [Benchmark, ArgumentsSource(nameof(GenerateRecords100))]
    public List<object> TakeLast_100_Faslinq(object item) => TakeLast_Faslinq(item, LastGenerateRecords100);

    [Benchmark, ArgumentsSource(nameof(GenerateRecords1000))]
    public List<object> TakeLast_1000_Faslinq(object item) => TakeLast_Faslinq(item, LastGenerateRecords1000);

    [Benchmark, ArgumentsSource(nameof(GenerateRecords1))]
    public List<object> TakeLast_1_Linq(object item) => TakeLast_Linq(item, LastGenerateRecords1);

    [Benchmark, ArgumentsSource(nameof(GenerateRecords10))]
    public List<object> TakeLast_10_Linq(object item) => TakeLast_Linq(item, LastGenerateRecords10);

    [Benchmark, ArgumentsSource(nameof(GenerateRecords100))]
    public List<object> TakeLast_100_Linq(object item) => TakeLast_Linq(item, LastGenerateRecords100);

    [Benchmark, ArgumentsSource(nameof(GenerateRecords1000))]
    public List<object> TakeLast_1000_Linq(object item) => TakeLast_Linq(item, LastGenerateRecords1000);

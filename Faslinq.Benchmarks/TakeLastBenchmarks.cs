...
public class TakeLastBenchmarks : BenchmarkBase
{
    ...
    public List<object> TakeLast_1_Faslinq(object item) => TakeLast_Faslinq(item, LastGenerateRecords1);

    [Benchmark, ArgumentsSource(nameof(GenerateRecords250))]
    public List<object> TakeLast_250_Faslinq(object item) => TakeLast_Faslinq(item, LastGenerateRecords1);

    [Benchmark, ArgumentsSource(nameof(GenerateRecords5000))]
    public List<object> TakeLast_5000_Faslinq(object item) => TakeLast_Faslinq(item, LastGenerateRecords5000);

    [Benchmark, ArgumentsSource(nameof(GenerateRecords100000))]
    public List<object> TakeLast_100000_Faslinq(object item) => TakeLast_Faslinq(item, LastGenerateRecords100000);
    ...
    public List<object> TakeLast_Faslinq(object item, TestValueTuple first)
    {
    ...
    [Benchmark, ArgumentsSource(nameof(GenerateRecords1))]
    public List<object> TakeLast_1_Linq(object item) => TakeLast_Linq(item, LastGenerateRecords1);

    [Benchmark, ArgumentsSource(nameof(GenerateRecords250))]
    public List<object> TakeLast_250_Linq(object item) => TakeLast_Linq(item, LastGenerateRecords250);

    [Benchmark, ArgumentsSource(nameof(GenerateRecords5000))]
    public List<object> TakeLast_5000_Linq(object item) => TakeLast_Linq(item, LastGenerateRecords5000);

    [Benchmark, ArgumentsSource(nameof(GenerateRecords100000))]
    public List<object> TakeLast_100000_Linq(object item) => TakeLast_Linq(item, LastGenerateRecords100000);


    public List<object>  TakeLast_Linq(object item, TestValueTuple first)
    {
        if (item is object[] array and { Length: 1 })
        {

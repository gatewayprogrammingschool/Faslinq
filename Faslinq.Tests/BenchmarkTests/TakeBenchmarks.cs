...
public abstract class TakeBenchmarks : CollectionBenchmarkBase
{
    ...
    public void Take_Array(object[] item) => Test(item, Benchmarks.Tests.Array);
    ...
    [DynamicData(nameof(GenerateTestRecords5000), typeof(BenchmarkBase), DynamicDataSourceType.Method)]
    // [DynamicData(nameof(GenerateTestRecords100000), typeof(BenchmarkBase), DynamicDataSourceType.Method)]
    public void Take_List(object[] item) => Test(item, Benchmarks.Tests.List);
    ...
    [DynamicData(nameof(GenerateTestRecords5000), typeof(BenchmarkBase), DynamicDataSourceType.Method)]
    // [DynamicData(nameof(GenerateTestRecords100000), typeof(BenchmarkBase), DynamicDataSourceType.Method)]
    public void Take_Linq(object[] item) => Test(item, Benchmarks.Tests.IEnumerable);

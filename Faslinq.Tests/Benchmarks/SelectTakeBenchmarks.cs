...
public class SelectTakeBenchmarks : BenchmarkBase
{
    ...
    public void SelectTake_250_Faslinq(object item) => SelectTake_Faslinq(item, FirstGenerateRecords250);

    [Benchmark, ArgumentsSource(nameof(GenerateRecords5000))]
    public void SelectTake_5000_Faslinq(object item) => SelectTake_Faslinq(item, FirstGenerateRecords5000);

    [Benchmark, ArgumentsSource(nameof(GenerateRecords100000))]
    public void SelectTake_100000_Faslinq(object item) => SelectTake_Faslinq(item, FirstGenerateRecords100000);

    [Benchmark, ArgumentsSource(nameof(GenerateRecords1))]
    public void SelectTake_1_Linq(object item) => SelectTake_Linq(item, FirstGenerateRecords1);

    [Benchmark, ArgumentsSource(nameof(GenerateRecords250))]
    public void SelectTake_250_Linq(object item) => SelectTake_Linq(item, FirstGenerateRecords250);

    [Benchmark, ArgumentsSource(nameof(GenerateRecords5000))]
    public void SelectTake_5000_Linq(object item) => SelectTake_Linq(item, FirstGenerateRecords5000);

    [Benchmark, ArgumentsSource(nameof(GenerateRecords100000))]
    public void SelectTake_100000_Linq(object item) => SelectTake_Linq(item, FirstGenerateRecords100000);

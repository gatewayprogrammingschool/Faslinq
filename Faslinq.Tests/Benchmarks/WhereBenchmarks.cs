...
public class WhereBenchmarks : BenchmarkBase
{
    ...
    public void Where_250_Faslinq(object item) => Where_Faslinq(item, FirstGenerateRecords250);

    [Benchmark, ArgumentsSource(nameof(GenerateRecords5000))]
    public void Where_5000_Faslinq(object item) => Where_Faslinq(item, FirstGenerateRecords5000);

    [Benchmark, ArgumentsSource(nameof(GenerateRecords100000))]
    public void Where_100000_Faslinq(object item) => Where_Faslinq(item, FirstGenerateRecords100000);

    [Benchmark, ArgumentsSource(nameof(GenerateRecords1))]
    public void Where_1_Linq(object item) => Where_Linq(item, FirstGenerateRecords1);

    [Benchmark, ArgumentsSource(nameof(GenerateRecords250))]
    public void Where_250_Linq(object item) => Where_Linq(item, FirstGenerateRecords250);

    [Benchmark, ArgumentsSource(nameof(GenerateRecords5000))]
    public void Where_5000_Linq(object item) => Where_Linq(item, FirstGenerateRecords5000);

    [Benchmark, ArgumentsSource(nameof(GenerateRecords100000))]
    public void Where_100000_Linq(object item) => Where_Linq(item, FirstGenerateRecords100000);

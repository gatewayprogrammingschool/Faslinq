...
public class WhereSelectTakeLastBenchmarks : BenchmarkBase
{
    ...
    public void WhereSelectTakeLast_250_Faslinq(object item) => WhereSelectTakeLast_Faslinq(item, LastGenerateRecords250);

    [Benchmark, ArgumentsSource(nameof(GenerateRecords5000))]
    public void WhereSelectTakeLast_5000_Faslinq(object item) => WhereSelectTakeLast_Faslinq(item, LastGenerateRecords5000);

    [Benchmark, ArgumentsSource(nameof(GenerateRecords100000))]
    public void WhereSelectTakeLast_100000_Faslinq(object item) => WhereSelectTakeLast_Faslinq(item, LastGenerateRecords100000);

    [Benchmark, ArgumentsSource(nameof(GenerateRecords1))]
    public void WhereSelectTakeLast_1_Linq(object item) => WhereSelectTakeLast_Linq(item, LastGenerateRecords1);

    [Benchmark, ArgumentsSource(nameof(GenerateRecords250))]
    public void WhereSelectTakeLast_250_Linq(object item) => WhereSelectTakeLast_Linq(item, LastGenerateRecords250);

    [Benchmark, ArgumentsSource(nameof(GenerateRecords5000))]
    public void WhereSelectTakeLast_5000_Linq(object item) => WhereSelectTakeLast_Linq(item, LastGenerateRecords5000);

    [Benchmark, ArgumentsSource(nameof(GenerateRecords100000))]
    public void WhereSelectTakeLast_100000_Linq(object item) => WhereSelectTakeLast_Linq(item, LastGenerateRecords100000);
